...
const PostForm = (props) => {
	...
	const adding = (e) => {
		...
		axios.post(`/api/boards/${props.boardId}/posts?title=${title}&description=${description}`, data).then((res) => {
...
const ConnectedPostForm = (props) => <AuthConsumer>{(auth) => <PostForm {...props} auth={auth} />}</AuthConsumer>;
